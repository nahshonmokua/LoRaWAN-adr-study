"""Every figure of the reproduction, drawn from tables/*.csv only.
...
from data_loading import FIGURES, PAPER_DIG, TABLES
FINAL = TABLES
...
ALL = {"fig04": fig04, "fig11": fig11, "fig12": fig12, "fig13": fig13, "fig14_15": fig14_15}


def save_all(final: Path = FINAL, figs: Path | None = None, dpi: int = 160) -> list[Path]:
    figs = figs or FIGURES; figs.mkdir(parents=True, exist_ok=True); done = []
